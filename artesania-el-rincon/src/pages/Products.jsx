...
// 1. Agregamos categorías y materiales a la data para que el filtro funcione
const articulos = [
  { 
    id: 1, 
...
export default function Products() {
  // 2. Definimos los estados para los filtros
  ...
  // Funciones para manejar cambios desde el Sidebar
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#121212' }}>
      {/* 4. Pasamos los estados y funciones al Sidebar como Props */}
      <Sidebar 
